...
class $MedicationsTable extends Medications
  ...
  static const VerificationMeta _preventiveSubtypeMeta = const VerificationMeta(
    'preventiveSubtype',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('preventive_subtype')) {
      context.handle(
        _preventiveSubtypeMeta,
        preventiveSubtype.isAcceptableOrUnknown(
          data['preventive_subtype']!,
          _preventiveSubtypeMeta,
        ),
      );
    }
    if (data.containsKey('injection_period_days')) {
      context.handle(
        _injectionPeriodDaysMeta,
        injectionPeriodDays.isAcceptableOrUnknown(
          data['injection_period_days']!,
          _injectionPeriodDaysMeta,
        ),
      );
    }
  ...
  Medication map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Medication(
      ...
      preventiveSubtype: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}preventive_subtype'],
      ),
      injectionPeriodDays: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}injection_period_days'],
      ),
...
class Medication extends DataClass implements Insertable<Medication> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || preventiveSubtype != null) {
      map['preventive_subtype'] = Variable<String>(preventiveSubtype);
    }
    if (!nullToAbsent || injectionPeriodDays != null) {
      map['injection_period_days'] = Variable<int>(injectionPeriodDays);
    }
  ...
  MedicationsCompanion toCompanion(bool nullToAbsent) {
    return MedicationsCompanion(
      ...
      preventiveSubtype: preventiveSubtype == null && nullToAbsent
          ? const Value.absent()
          : Value(preventiveSubtype),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'preventiveSubtype': serializer.toJson<String?>(preventiveSubtype),
      'injectionPeriodDays': serializer.toJson<int?>(injectionPeriodDays),
  ...
  Medication copyWith({
    ...
    Value<String?> preventiveSubtype = const Value.absent(),
    Value<int?> injectionPeriodDays = const Value.absent(),
  ...
  Medication copyWithCompanion(MedicationsCompanion data) {
    return Medication(
      ...
      reminderMinutes: data.reminderMinutes.present
          ...
          : this.reminderMinutes,
      preventiveSubtype: data.preventiveSubtype.present
          ? data.preventiveSubtype.value
          : this.preventiveSubtype,
      injectionPeriodDays: data.injectionPeriodDays.present
          ? data.injectionPeriodDays.value
          : this.injectionPeriodDays,
  ...
  String toString() {
    return (StringBuffer('Medication(')
          ...
          ..write('preventiveSubtype: $preventiveSubtype, ')
          ..write('injectionPeriodDays: $injectionPeriodDays, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Medication &&
          ...
          other.preventiveSubtype == this.preventiveSubtype &&
          other.injectionPeriodDays == this.injectionPeriodDays &&
...
class MedicationsCompanion extends UpdateCompanion<Medication> {
  ...
  final Value<String?> preventiveSubtype;
  final Value<int?> injectionPeriodDays;
  ...
  const MedicationsCompanion({
    ...
    this.preventiveSubtype = const Value.absent(),
    this.injectionPeriodDays = const Value.absent(),
  ...
  static Insertable<Medication> custom({
    ...
    Expression<String>? preventiveSubtype,
    Expression<int>? injectionPeriodDays,
  ...
  MedicationsCompanion copyWith({
    ...
    Value<String?>? preventiveSubtype,
    Value<int?>? injectionPeriodDays,
    ...
    return MedicationsCompanion(
      ...
      preventiveSubtype: preventiveSubtype ?? this.preventiveSubtype,
      injectionPeriodDays: injectionPeriodDays ?? this.injectionPeriodDays,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (preventiveSubtype.present) {
      map['preventive_subtype'] = Variable<String>(preventiveSubtype.value);
    }
    if (injectionPeriodDays.present) {
      map['injection_period_days'] = Variable<int>(injectionPeriodDays.value);
    }
...
class $AppointmentsTable extends Appointments
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('occurs_at')) {
      context.handle(
        _occursAtMeta,
        occursAt.isAcceptableOrUnknown(data['occurs_at']!, _occursAtMeta),
      );
    } else if (isInserting) {
      context.missing(_occursAtMeta);
    }
  ...
  Appointment map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Appointment(
      ...
      occursAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}occurs_at'],
      )!,
...
class Appointment extends DataClass implements Insertable<Appointment> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<String>(id);
    map['user_id'] = Variable<String>(userId);
    map['occurs_at'] = Variable<DateTime>(occursAt);
  ...
  factory Appointment.fromJson(
    ...
    return Appointment(
      id: serializer.fromJson<String>(json['id']),
      userId: serializer.fromJson<String>(json['userId']),
      occursAt: serializer.fromJson<DateTime>(json['occursAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<String>(id),
      'userId': serializer.toJson<String>(userId),
      'occursAt': serializer.toJson<DateTime>(occursAt),
  ...
  Appointment copyWith({
    ...
    id: id ?? this.id,
    userId: userId ?? this.userId,
    occursAt: occursAt ?? this.occursAt,
...
class AppointmentsCompanion extends UpdateCompanion<Appointment> {
  ...
  const AppointmentsCompanion({
    this.id = const Value.absent(),
    this.userId = const Value.absent(),
    this.occursAt = const Value.absent(),
  ...
  static Insertable<Appointment> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (userId != null) 'user_id': userId,
      if (occursAt != null) 'occurs_at': occursAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (occursAt.present) {
      map['occurs_at'] = Variable<DateTime>(occursAt.value);
    }
...
class $Hit6ResponsesTable extends Hit6Responses
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $Hit6ResponsesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'hit6_responses';
  @override
  VerificationContext validateIntegrity(
    Insertable<Hit6Response> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  $Hit6ResponsesTable createAlias(String alias) {
    return $Hit6ResponsesTable(attachedDatabase, alias);
  }
}

class Hit6Response extends DataClass implements Insertable<Hit6Response> {
  final String id;
  final String userId;
  ...
  Hit6ResponsesCompanion toCompanion(bool nullToAbsent) {
    return Hit6ResponsesCompanion(
      id: Value(id),
      userId: Value(userId),
  ...
  Hit6Response copyWithCompanion(Hit6ResponsesCompanion data) {
    return Hit6Response(
      id: data.id.present ? data.id.value : this.id,
      userId: data.userId.present ? data.userId.value : this.userId,
  ...
  @override
  String toString() {
    return (StringBuffer('Hit6Response(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
...
class Hit6ResponsesCompanion extends UpdateCompanion<Hit6Response> {
  final Value<String> id;
  final Value<String> userId;
  ...
  Hit6ResponsesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       score = Value(score),
       responses = Value(responses);
  static Insertable<Hit6Response> custom({
    Expression<String>? id,
    Expression<String>? userId,
  ...
  Hit6ResponsesCompanion copyWith({
    Value<String>? id,
    Value<String>? userId,
  ...
  @override
  String toString() {
    return (StringBuffer('Hit6ResponsesCompanion(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('submittedAt: $submittedAt, ')
          ..write('score: $score, ')
...
class $CrisesTable extends Crises with TableInfo<$CrisesTable, Crisis> {
  ...
  Crisis map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Crisis(
      ...
      menstruation: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}menstruation'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class Crisis extends DataClass implements Insertable<Crisis> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || menstruation != null) {
      map['menstruation'] = Variable<bool>(menstruation);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
    return map;
  ...
  factory Crisis.fromJson(
    ...
    return Crisis(
      ...
      menstruation: serializer.fromJson<bool?>(json['menstruation']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'menstruation': serializer.toJson<bool?>(menstruation),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
    };
  }
  ...
  Crisis copyWith({
    ...
    Value<bool?> menstruation = const Value.absent(),
    DateTime? createdAt,
    DateTime? updatedAt,
  }) => Crisis(
    id: id ?? this.id,
    ...
    menstruation: menstruation.present ? menstruation.value : this.menstruation,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
  );
  ...
  String toString() {
    return (StringBuffer('Crisis(')
          ...
          ..write('menstruation: $menstruation, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      ...
      (other is Crisis &&
          ...
          other.menstruation == this.menstruation &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt);
}
...
class CrisesCompanion extends UpdateCompanion<Crisis> {
  ...
  const CrisesCompanion({
    ...
    this.menstruation = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (menstruation.present) {
      map['menstruation'] = Variable<bool>(menstruation.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
abstract class _$AuraDatabase extends GeneratedDatabase {
  ...
  late final $Hit6ResponsesTable hit6Responses = $Hit6ResponsesTable(this);
  ...
  late final Index appointmentsUserWhenIdx = Index(
    ...
    'CREATE INDEX appointments_user_when_idx ON appointments (user_id, occurs_at)',
  );
  late final Index hit6UserRecentIdx = Index(
    'hit6_user_recent_idx',
    'CREATE INDEX hit6_user_recent_idx ON hit6_responses (user_id, submitted_at)',
  );
...
class $$MedicationsTableFilterComposer
  ...
  ColumnFilters<String> get preventiveSubtype => $composableBuilder(
    column: $table.preventiveSubtype,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get injectionPeriodDays => $composableBuilder(
...
class $$MedicationsTableOrderingComposer
  ...
  ColumnOrderings<String> get preventiveSubtype => $composableBuilder(
    column: $table.preventiveSubtype,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get injectionPeriodDays => $composableBuilder(
    column: $table.injectionPeriodDays,
    builder: (column) => ColumnOrderings(column),
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                preventiveSubtype: preventiveSubtype,
                injectionPeriodDays: injectionPeriodDays,
                startedAt: startedAt,
                endedAt: endedAt,
                createdAt: createdAt,
                updatedAt: updatedAt,
...
class $$AppointmentsTableTableManager
    extends
        RootTableManager<
          ...
          PrefetchHooks Function()
        > {
  $$AppointmentsTableTableManager(_$AuraDatabase db, $AppointmentsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> userId = const Value.absent(),
                Value<DateTime> occursAt = const Value.absent(),
                Value<String?> doctorName = const Value.absent(),
                Value<String?> location = const Value.absent(),
                Value<String?> notes = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
...
typedef $$AppointmentsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$Hit6ResponsesTableCreateCompanionBuilder =
    Hit6ResponsesCompanion Function({
      required String id,
      required String userId,
      required DateTime submittedAt,
      required int score,
...
typedef $$Hit6ResponsesTableUpdateCompanionBuilder =
    Hit6ResponsesCompanion Function({
      Value<String> id,
      Value<String> userId,
      Value<DateTime> submittedAt,
...
class $$Hit6ResponsesTableTableManager
    extends
        RootTableManager<
          _$AuraDatabase,
          $Hit6ResponsesTable,
          ...
          PrefetchHooks Function()
        > {
  $$Hit6ResponsesTableTableManager(_$AuraDatabase db, $Hit6ResponsesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          createComputedFieldComposer: () =>
              $$Hit6ResponsesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> userId = const Value.absent(),
...
typedef $$Hit6ResponsesTableProcessedTableManager =
    ProcessedTableManager<
      _$AuraDatabase,
      $Hit6ResponsesTable,
      Hit6Response,
